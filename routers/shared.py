...
shared_router = APIRouter(prefix='/shared', tags={'Everything available for users with specific roles.'})
...
def create_player(full_name: str = Query(..., description='Enter full name of player:'),
    ...
    if User.is_admin(user):
        created_player = shared_service.create_player(full_name, country, sport_club)
