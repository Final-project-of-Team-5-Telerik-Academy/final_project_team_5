...
def create_match(x_token: str = Header(),
    ...
    # TODO: check for admin and director
    # check real user
    get_user_or_raise_401(x_token)

    # check if director   TODO: get new validator
    if not x_token == 'director':
        return JSONResponse(content='Only directors can create matches.')
